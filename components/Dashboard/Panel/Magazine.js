...
export default class News extends Component {
  ...
  componentDidMount() {
    axios.get("https://daliran.disizali.now.sh/api/magazine").then(({ data }) => {
  ...
  sendMagazine() {
    ...
    axios
      .post("https://daliran.disizali.now.sh/api/magazine", {
        faName,
        enName,
        image
      })
  ...
  deleteMagazine(targetId) {
    ...
    axios
      .delete("https://daliran.disizali.now.sh/api/magazine", { data: { targetId } })
      .then(({ data }) => {
        if (data == "no magazine") {
          return;
        }
